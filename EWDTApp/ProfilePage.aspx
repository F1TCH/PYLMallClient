                            ...
                            <div class="row">
                                ...
                                <div class="profileTable">
                                    <table class="table table-bordered table-striped" >
                                            ...
                                            <tr>
                                                <td class="auto-style1" style="color: #000000">Qualification</td>
                                                <td style="color: #000000">
                                                    <asp:Label ID="lblQualification" runat="server"></asp:Label></td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style1" style="color: #000000">Work Experience</td>
                                                <td style="color: #000000">
                                                    <asp:Label ID="lblWorkExperience" runat="server"></asp:Label></td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style1" style="color: #000000">Unique Key</td>
                                                <td style="color: #000000">
                                                    <asp:Label ID="lblUniquekey" runat="server"></asp:Label></td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style1" style="color: #000000">Additional Info</td>
                                                <td style="color: #000000">
